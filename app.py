...
def init_db():
    ...
    # Сбросить статусы checked_out (оставшиеся после отката функции авто-выселения)
    cur.execute("UPDATE bookings SET status = 'active' WHERE status = 'checked_out'")

    # Восстановить статус 'paid' по данным из xlsx-бэкапа от 01.08.2026
    _restore_paid = [
        ('Б-10', '2026-06-12', '2026-06-14'),
        ('Б-12', '2026-06-12', '2026-06-14'),
        ('Б-10', '2026-06-21', '2026-06-23'),
        ('Б-10', '2026-06-25', '2026-07-01'),
        ('5202', '2026-07-03', '2026-07-06'),
        ('Б-12', '2026-07-03', '2026-07-05'),
        ('236',  '2026-07-06', '2026-07-16'),
        ('К-7',  '2026-07-06', '2026-07-10'),
        ('5303', '2026-07-09', '2026-07-12'),
        ('Б-12', '2026-07-10', '2026-07-12'),
        ('К-8',  '2026-07-10', '2026-07-14'),
        ('Б-10', '2026-07-11', '2026-07-13'),
        ('321',  '2026-07-11', '2026-07-18'),
        ('К-7',  '2026-07-11', '2026-07-13'),
        ('5202', '2026-07-12', '2026-07-15'),
        ('К-7',  '2026-07-13', '2026-07-15'),
        ('К-6',  '2026-07-13', '2026-07-16'),
        ('Б-12', '2026-07-14', '2026-07-16'),
        ('Б-10', '2026-07-14', '2026-07-16'),
        ('5303', '2026-07-14', '2026-07-16'),
        ('Б-11', '2026-07-14', '2026-07-16'),
        ('Т-5',  '2026-07-15', '2026-07-17'),
        ('К-7',  '2026-07-15', '2026-07-19'),
        ('Т-3',  '2026-07-15', '2026-07-20'),
        ('236',  '2026-07-16', '2026-07-21'),
        ('231',  '2026-07-16', '2026-07-20'),
        ('221',  '2026-07-16', '2026-07-20'),
        ('235',  '2026-07-16', '2026-07-18'),
        ('5302', '2026-07-16', '2026-07-19'),
        ('5201', '2026-07-16', '2026-07-18'),
        ('Т-2',  '2026-07-16', '2026-07-26'),
        ('223',  '2026-07-16', '2026-07-19'),
        ('335',  '2026-07-16', '2026-07-21'),
        ('5303', '2026-07-17', '2026-07-20'),
        ('Б-12', '2026-07-17', '2026-07-20'),
        ('Т-6',  '2026-07-17', '2026-07-19'),
        ('Б-11', '2026-07-17', '2026-07-19'),
        ('Б-2',  '2026-07-17', '2026-07-20'),
        ('К-6',  '2026-07-17', '2026-07-20'),
        ('5301', '2026-07-17', '2026-07-20'),
        ('5202', '2026-07-17', '2026-07-19'),
        ('К-8',  '2026-07-17', '2026-07-20'),
        ('312',  '2026-07-17', '2026-07-20'),
        ('Б-10', '2026-07-18', '2026-07-23'),
        ('Т-5',  '2026-07-18', '2026-07-25'),
        ('5201', '2026-07-18', '2026-07-20'),
        ('321',  '2026-07-19', '2026-07-24'),
        ('5202', '2026-07-19', '2026-07-24'),
        ('231',  '2026-07-20', '2026-07-27'),
        ('К-7',  '2026-07-20', '2026-07-22'),
        ('Б-12', '2026-07-20', '2026-07-24'),
        ('312',  '2026-07-20', '2026-07-22'),
        ('К-6',  '2026-07-20', '2026-07-30'),
        ('5301', '2026-07-20', '2026-07-22'),
        ('221',  '2026-07-21', '2026-07-24'),
        ('Т-6',  '2026-07-22', '2026-07-29'),
        ('335',  '2026-07-23', '2026-08-08'),
        ('5301', '2026-07-23', '2026-07-25'),
        ('221',  '2026-07-24', '2026-07-26'),
        ('К-7',  '2026-07-25', '2026-07-29'),
        ('5202', '2026-07-25', '2026-08-01'),
        ('332',  '2026-07-25', '2026-08-02'),
        ('235',  '2026-07-26', '2026-08-01'),
        ('5302', '2026-07-26', '2026-08-01'),
        ('232',  '2026-07-27', '2026-08-01'),
        ('5301', '2026-07-27', '2026-08-03'),
        ('5303', '2026-07-27', '2026-08-03'),
        ('236',  '2026-07-28', '2026-07-31'),
        ('5201', '2026-07-29', '2026-08-05'),
        ('Т-5',  '2026-07-29', '2026-08-01'),
        ('Т-6',  '2026-07-29', '2026-08-01'),
        ('Т-3',  '2026-07-29', '2026-08-01'),
        ('221',  '2026-07-30', '2026-08-01'),
        ('К-6',  '2026-07-31', '2026-08-02'),
        ('К-7',  '2026-07-31', '2026-08-02'),
        ('5202', '2026-08-01', '2026-08-08'),
        ('Т-2',  '2026-08-01', '2026-08-07'),
        ('236',  '2026-08-01', '2026-08-09'),
        ('Т-5',  '2026-08-03', '2026-08-06'),
    ]
    for cottage_name, ci, co in _restore_paid:
        cur.execute("""
            UPDATE bookings SET status = 'paid'
            WHERE check_in = %s AND check_out = %s
              AND cottage_id = (SELECT id FROM cottages WHERE name = %s)
              AND status = 'active'
        """, (ci, co, cottage_name))
